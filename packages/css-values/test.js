...
test(valid, webkitBorderBeforeWidth, "calc(12.22)");
...
var webkitMaskAttachment = ["-webkit-mask-attachment", "background-attachment"];
test(globals, webkitMaskAttachment);
test(valid, webkitMaskAttachment, "scroll");
test(valid, webkitMaskAttachment, "fixed");
test(valid, webkitMaskAttachment, "local");
test(valid, webkitMaskAttachment, "SCROLL");
test(valid, webkitMaskAttachment, "FIXED");
test(valid, webkitMaskAttachment, "LOCAL");
test(invalid, webkitMaskAttachment, "local-scroll");
test(valid, webkitMaskAttachment, "scroll, scroll");
test(invalid, webkitMaskAttachment, "scroll, scroll,");
test(valid, webkitMaskAttachment, "var(--foo), var(--bar)");
test(invalid, webkitMaskAttachment, "var(--foo), var(--bar),");
...
test(valid, webkitTextStrokeWidth, "calc(12.22)");
...
var backgroundSize = ["background-size", "mask-size"];
test(globals, backgroundSize);
test(valid, backgroundSize, "10px");
test(valid, backgroundSize, "50%");
test(valid, backgroundSize, "50% auto");
test(valid, backgroundSize, "auto 10px");
test(valid, backgroundSize, "cover");
test(valid, backgroundSize, "contain");
test(valid, backgroundSize, "COVER");
test(valid, backgroundSize, "CONTAIN");
test(invalid, backgroundSize, "10px foo");
test(invalid, backgroundSize, "10 pixels");
test(invalid, backgroundSize, "awto awto");
test(invalid, backgroundSize, "10px 10px 10px 10px");
test(valid, backgroundSize, "10px, 10px");
test(invalid, backgroundSize, "10px, 10px,");
test(valid, backgroundSize, "var(--foo), var(--bar)");
test(invalid, backgroundSize, "var(--foo), var(--bar),");
...
test(valid, borderBottomLeftRadius, "calc(12.22)");
...
test(valid, borderBottomWidth, "calc(12.22)");
...
test(valid, columnGap, "calc(12.22)");
...
test(valid, columnWidth, "calc(12.22)");
...
test(valid, fontSize, "calc(12.22)");
...
var gridAutoColumns = ["grid-auto-columns", "grid-auto-rows"];
test(globals, gridAutoColumns);
test(valid, gridAutoColumns, "minmax(2em, 300px)");
test(valid, gridAutoColumns, "minmax(max-content, 2fr)");
test(valid, gridAutoColumns, "minmax(20%, 80vmax)");
test(valid, gridAutoColumns, "min-content");
test(valid, gridAutoColumns, "max-content");
test(valid, gridAutoColumns, "auto");
test(valid, gridAutoColumns, "calc(40px)");
test(valid, gridAutoColumns, "calc(100%)");
test(valid, gridAutoColumns, "calc(12)");
test(valid, gridAutoColumns, "calc(12.22)");
test(valid, gridAutoColumns, "calc(90deg)");
test(valid, gridAutoColumns, "calc(1500ms)");
test(valid, gridAutoColumns, "calc(var(--someVar))");
test(valid, gridAutoColumns, "calc(100% - 80px)");
test(valid, gridAutoColumns, "calc(80px + 2 * 1em)");
test(valid, gridAutoColumns, "calc(var(--widthA) / 2)");
test(valid, gridAutoColumns, "calc(10px + (16px - 12px))");
test(valid, gridAutoColumns, "0");
test(valid, gridAutoColumns, "16px");
test(valid, gridAutoColumns, "1pc");
test(valid, gridAutoColumns, "2.34254645654324rem");
test(valid, gridAutoColumns, "1%");
test(valid, gridAutoColumns, "88%");
test(valid, gridAutoColumns, "99.99%");
test(valid, gridAutoColumns, "+100%");
test(valid, gridAutoColumns, ".25fr");
test(valid, gridAutoColumns, "0.5fr");
test(valid, gridAutoColumns, "1fr");
test(valid, gridAutoColumns, "2fr");
test(invalid, gridAutoColumns, "minmax(20kHz, max-content)");
test(invalid, gridAutoColumns, "minmax(80vmax, 20kHz)");
test(invalid, gridAutoColumns, "minmax(1rem 20px)");
test(invalid, gridAutoColumns, "maxmin(auto, 30%)");
test(invalid, gridAutoColumns, "calc(12px-6px)");
test(invalid, gridAutoColumns, "calc(12px12px)");
test(invalid, gridAutoColumns, "calc(url(qwe.jpg))");
test(invalid, gridAutoColumns, "calc(12px*)");
test(invalid, gridAutoColumns, "calc(abc)");
test(invalid, gridAutoColumns, "calc()");
test(invalid, gridAutoColumns, "calc(+ 12px)");
test(invalid, gridAutoColumns, "calc(12px -)");
test(invalid, gridAutoColumns, "calc(12px + ())");
test(invalid, gridAutoColumns, "cacl()");
test(invalid, gridAutoColumns, "16.px");
test(invalid, gridAutoColumns, "px16");
test(invalid, gridAutoColumns, "one rem");
test(invalid, gridAutoColumns, "\"1rem\"");
test(invalid, gridAutoColumns, "12.%");
test(invalid, gridAutoColumns, "42.2.3.4.7.8.1.2%");
test(invalid, gridAutoColumns, "-0.5fr");
test(invalid, gridAutoColumns, "-2fr");
test(invalid, gridAutoColumns, "minmax(2em, 300px) minmax(2em, 300px)");
...
test(valid, gridColumnGap, "calc(12.22)");
...
test(valid, letterSpacing, "calc(12.22)");
...
test(valid, lineHeight, "calc(12.22)");
...
var maskOrigin = "mask-origin";
test(globals, maskOrigin);
test(valid, maskOrigin, "margin-box");
test(valid, maskOrigin, "fill-box");
test(valid, maskOrigin, "stroke-box");
test(valid, maskOrigin, "view-box");
test(valid, maskOrigin, "content");
test(valid, maskOrigin, "padding");
test(valid, maskOrigin, "border");
test(valid, maskOrigin, "border-box");
test(valid, maskOrigin, "padding-box");
test(valid, maskOrigin, "content-box");
test(valid, maskOrigin, "BORDER-BOX");
test(valid, maskOrigin, "PADDING-BOX");
test(valid, maskOrigin, "CONTENT-BOX");
test(valid, maskOrigin, "view-box, fill-box, border-box");
test(invalid, maskOrigin, "rock-box");
test(invalid, maskOrigin, "view-box, fill-box, 1px");
test(valid, maskOrigin, "margin-box, margin-box");
test(invalid, maskOrigin, "margin-box, margin-box,");
test(valid, maskOrigin, "var(--foo), var(--bar)");
test(invalid, maskOrigin, "var(--foo), var(--bar),");
...
test(valid, maxBlockSize, "calc(12.22)");
...
test(valid, perspective, "calc(12.22)");
...
test(globals, textShadow);
test(validCI, textShadow, "none");
test(invalid, textShadow, "none none");
test(valid, textShadow, "1px 1px 2px black");
test(valid, textShadow, "#CCC 1px 0 10px");
test(valid, textShadow, "5px 5px #558ABB");
test(valid, textShadow, "white 2px 5px");
test(valid, textShadow, "5px 10px");
test(valid, textShadow, "white var(--foo) var(--bar)");
test(valid, textShadow, "var(--foo) var(--bar) var(--baz)");
test(valid, textShadow, "var(--foo) var(--bar) var(--baz) var(--quux)");
test(valid, textShadow, "1px 1px 2px black, 1px 1px 2px black");
test(valid, textShadow, "#CCC 1px 0 10px, #CCC 1px 0 10px");
test(valid, textShadow, "5px 5px #558ABB, 5px 5px #558ABB");
test(valid, textShadow, "white 2px 5px, white 2px 5px");
test(valid, textShadow, "5px 10px, 5px 10px");
test(valid, textShadow, "white var(--foo) var(--bar), white var(--foo) var(--bar)");
test(valid, textShadow, "var(--foo) var(--bar) var(--baz), var(--foo) var(--bar) var(--baz)");
test(valid, textShadow, "var(--foo) var(--bar) var(--baz) var(--quux), var(--foo) var(--bar) var(--baz) var(--quux)");
test(invalid, textShadow, "5px");
test(invalid, textShadow, "5px 10px 15px 20px");
test(invalid, textShadow, "white");
test(invalid, textShadow, "white 5px");
test(invalid, textShadow, "white 5px 5px white");
test(invalid, textShadow, "white/2px/5px");
test(invalid, textShadow, "5px 5px foobar");
test(invalid, textShadow, "5px white 5px");
test(invalid, textShadow, "var(--foo) var(--bar) var(--baz) var(--quux) var(--foobar)");
test(invalid, textShadow, "white 2px 5px,");
...
test(globals, transform);
test(validCI, transform, "none");
test(invalid, transform, "none none");
test(valid, transform, "matrix(1, -0.3, 0, 1, 0, 0)");
test(valid, transform, "matrix3d(1, 0, 0.00, 0, 0.00, 0, 1.00, 0.008, 0, -1, 0, 0, 0, 0, 0, 1)");
test(valid, transform, "translate(50%, 50%)");
test(valid, transform, "translate(50px, 50px)");
test(valid, transform, "translate(10%)");
test(valid, transform, "translateX(10%)");
test(valid, transform, "translateY(10%)");
test(valid, transform, "translateX(50px)");
test(valid, transform, "translateY(50px)");
test(valid, transform, "scale(2, 2)");
test(valid, transform, "scale(2)");
test(valid, transform, "rotate(90deg)");
test(valid, transform, "skewX(90deg)");
test(valid, transform, "skewY(90deg)");
test(valid, transform, "rotateX(90deg)");
test(valid, transform, "rotateY(90deg)");
test(valid, transform, "rotateZ(90deg)");
test(valid, transform, "perspective(100px)");
test(valid, transform, "translateZ(100px)");
test(valid, transform, "scaleX(2)");
test(valid, transform, "scaleY(2)");
test(valid, transform, "scaleZ(2)");
test(valid, transform, "scale3d(2, 2, 1)");
test(valid, transform, "skew(90deg, 90deg)");
test(valid, transform, "skew(0.5turn)");
test(valid, transform, "translate3d(10%, 10%, 100px)");
test(valid, transform, "rotate3d(10, 10, 10, 90deg)");
test(invalid, transform, "matrix(-0.3)");
test(invalid, transform, "matrix(1, 0.3, 0, 1, 0, zero)");
test(invalid, transform, "matrix(1 -0.3 0 1 0 0)");
test(invalid, transform, "translate(50% 50%)");
test(invalid, transform, "translate(10px,)");
test(invalid, transform, "translate(10px, 10px, 10px)");
test(invalid, transform, "translateX(10px 10px)");
test(invalid, transform, "translateY(10px 10px)");
test(invalid, transform, "scale(2 2)");
test(invalid, transform, "scale(2,)");
test(invalid, transform, "scale(2, 2, 2)");
test(invalid, transform, "rotate(90 degrees)");
test(invalid, transform, "skewX(90 degrees)");
test(invalid, transform, "skewY(90 degrees)");
test(invalid, transform, "rotateX(90 degrees)");
test(invalid, transform, "rotateY(90 degrees)");
test(invalid, transform, "rotateZ(90 degrees)");
test(invalid, transform, "perspective(100)");
test(invalid, transform, "translateZ(100)");
test(invalid, transform, "scaleX(2 2)");
test(invalid, transform, "scaleY(2 2)");
test(invalid, transform, "scaleZ(2 2)");
test(invalid, transform, "scaleX(2, 2)");
test(invalid, transform, "scaleY(2, 2)");
test(invalid, transform, "scaleZ(2, 2)");
test(invalid, transform, "scale3d(2 2 1)");
test(invalid, transform, "scale3d(2, 2, 1,)");
test(invalid, transform, "skew(0.5turn,)");
test(invalid, transform, "skew(90deg, 90deg, 90deg)");
test(invalid, transform, "skew(foo)");
test(invalid, transform, "skew(90deg 90deg)");
test(invalid, transform, "translate3d(10px 10px 10px)");
test(invalid, transform, "translate3d(10%, 10%, 10%, 10%)");
test(invalid, transform, "translate3d(10%, 10%,)");
test(invalid, transform, "rotate3d(10, 10, 10, 10)");
test(invalid, transform, "rotate3d(10)");
test(invalid, transform, "rotate3d(10 10 10 90deg)");
test(valid, transform, "matrix(1, -0.3, 0, 1, 0, 0) matrix(1, -0.3, 0, 1, 0, 0)");
test(invalid, transform, "matrix(1, -0.3, 0, 1, 0, 0), matrix(1, -0.3, 0, 1, 0, 0)");
test(valid, transform, "var(--foo) var(--bar)");
test(invalid, transform, "var(--foo), var(--bar)");
...
test(valid, verticalAlign, "calc(12.22)");
...
test(valid, wordSpacing, "calc(12.22)");
