...
test(valid, borderImageSource, "radial-gradient(ellipse 10%, red, blue)");
test(valid, borderImageSource, "repeating-radial-gradient(ellipse 10%, red, blue)");
test(valid, borderImageSource, "radial-gradient(10% ellipse, red, blue)");
test(valid, borderImageSource, "repeating-radial-gradient(10% ellipse, red, blue)");
