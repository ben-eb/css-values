...
test(invalid, animationIterationCount, "\"px-10px\"");
...
test(invalid, columnCount, "\"px-10px\"");
...
test(invalid, fontSizeAdjust, "\"px-10px\"");
...
test(invalid, lineHeight, "\"px-10px\"");
